...
def list_mobiles(request):
    if request.user.is_superuser:
        ...
        return render(request,"administrator/listmobiles.html",context)
    else:
         return redirect("logout")
...
def view_mobile(request,id):
    if request.user.is_superuser:
        ...
        return render(request,"administrator/viewmobile.html",context)
    else:
        return redirect("logout")
def admin_view_order(request):
    if request.user.is_superuser:
        ...
        return render(request,"administrator/userorders.html",context)
    else:
        return redirect("logout")
